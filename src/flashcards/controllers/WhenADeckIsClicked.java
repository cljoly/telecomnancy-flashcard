...
public class WhenADeckIsClicked implements EventHandler<ActionEvent> {
    ...
    public WhenADeckIsClicked(Button button, VBox list_of_cards_container, TextArea recto_details, TextArea verso_details, Button add_change_to_card, Button unsave_changes, Button delete_card) {
        this.b = button;
